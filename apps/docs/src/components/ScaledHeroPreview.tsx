import { childrenFromSlots, useEffect, useRef, useState } from "vfx-ui-vue/compat";
import type { VNodeChild } from "vue";

/** Render the whole composition at a real desktop size, then fit the stage. */
export function ScaledHeroPreview({ children }: { children?: VNodeChild }) {
  ...
  return (
    <div ref={ref} class="scaled-hero-preview">
      <div
        style={{
          width: logicalWidth,
