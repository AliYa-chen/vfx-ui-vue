const DEFAULT_BROWSE_CONTENT = Object.freeze({
  title: "Shader effect components for Vue 3",
...
const CATEGORY_CONTENT = Object.freeze({
  Heroes: Object.freeze({
    title: "Hero Section Components for Vue 3",
  ...
  Footers: Object.freeze({
    title: "Interactive Footer Components for Vue 3",
  ...
  Backgrounds: Object.freeze({
    ...
    description: "Browse interactive WebGPU shader backgrounds, gradient fields, and ambient GPU effects for Vue interfaces.",
  }),
  Interactions: Object.freeze({ title: "Interactive Vue Components", heading: "Made to be touched.", description: "Magnetic movement, spatial cards, and tactile details for your own content." }),
  Text: Object.freeze({
  ...
  Glass: Object.freeze({
    ...
    description: "Browse GPU glass components with refraction, blur, and liquid glass surfaces for Vue.",
  }),
});
...
export function browseTagContent(tag, resultCount = 0) {
  ...
  return {
    ...
    description: `Explore ${countText}vfx-ui-vue components and interactive GPU effects tagged ${label}, with live previews and copy-ready usage code.`,
  };
}
