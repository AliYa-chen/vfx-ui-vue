...
export const SITE_TITLE = "Interactive visual components for Vue 3";
export const SITE_DESCRIPTION = "Interactive visual components for Vue 3: cinematic WebGPU backgrounds, customizable heroes and footers, kinetic typography, magnetic controls, and spectral cards.";
...
export function buildRouteSeo(route, origin, catalog = []) {
  ...
  if (route.page === "home") {
    ...
    title = "VFX UI VUE — Interactive Visual Components for Vue 3";
    ...
    structuredData = {
      ...
      about: { "@type": "SoftwareApplication", name: "vfx-ui-vue", applicationCategory: "DeveloperApplication" },
    };
  } else if (route.page === "installation") {
    title = brandedTitle("Install vfx-ui-vue");
    description = "Install vfx-ui-vue, check WebGPU requirements, and render your first GPU shader component.";
    structuredData = {
      "@context": "https://schema.org",
      "@type": "TechArticle",
      headline: "Install vfx-ui-vue",
      description,
    ...
    description = "The requested vfx-ui-vue page could not be found. Browse the complete component collection instead.";
  } else {
...
export function applyRouteSeo(route, catalog = []) {
  ...
  upsertMeta('meta[property="og:site_name"]', { property: "og:site_name", content: "VFX UI VUE" });
  ...
  let structuredData = document.head.querySelector("#vfx-ui-vue-structured-data");
  if (seo.structuredData) {
    if (!structuredData) {
      structuredData = document.createElement("script");
      structuredData.id = "vfx-ui-vue-structured-data";
