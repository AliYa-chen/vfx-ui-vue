...
- Magnetic controls retain a stationary hit region. Motion settles through an imperative animation loop instead of causing Vue renders on every pointer movement.
...
- Hero copy is example content. Accept Vue VNodes, actionable CTA objects, or a fully custom default slot; never require the demonstration wording.
