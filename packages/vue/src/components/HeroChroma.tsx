import { childrenFromSlots } from "../vueCompat";
...
export interface HeroChromaProps extends HeroContentProps {
   ...
   * across all vfx-ui-vue backgrounds and heroes.
   */
}

/**
 * Bottom-left copy over a four-edge chroma field — the reddit-ai-assistant
 * landing hero, abstracted into an original vfx-ui-vue shader + the shared
...
export function HeroChroma({
  ...
  return (
    <HeroShell
      {...shellProps}
      children={childrenFromSlots(shellProps.children)}
      layout="left"
      scheme={scheme}
      eyebrow={eyebrow}
      title={title}
